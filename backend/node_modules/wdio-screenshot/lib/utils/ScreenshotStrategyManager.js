...
var _TrimAndMergeScreenshotStrategy = require('./strategies/TrimAndMergeScreenshotStrategy');

var _TrimAndMergeScreenshotStrategy2 = _interopRequireDefault(_TrimAndMergeScreenshotStrategy);
  ...
  (0, _createClass3.default)(ScreenshotStrategyManager, null, [{
    ...
    value: function getStrategy(browser, screenDimensions) {
      ...
      if (isIOS) {
        ...
        return new _TrimAndMergeScreenshotStrategy2.default(screenDimensions);
      }
